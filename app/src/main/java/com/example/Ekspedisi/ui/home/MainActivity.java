package com.example.Ekspedisi.ui.home;
...
import com.example.Ekspedisi.data.cost.DataType;
import com.example.Ekspedisi.rating.RatingActivity;
import com.example.Ekspedisi.rating.ReadActivity;
import com.example.Ekspedisi.ui.search.SearchCityActivity;
...
public class MainActivity extends AppCompatActivity implements MainContract.View {
    ...
    Button btnSubmit, btnRating, btnTampil;
    LinearLayout llMain;
    RecyclerView rvMain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRating.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent moveIntent = new Intent(MainActivity.this, RatingActivity.class);
